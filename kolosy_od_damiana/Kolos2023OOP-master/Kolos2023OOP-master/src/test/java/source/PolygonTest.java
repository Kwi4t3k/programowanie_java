...
public class PolygonTest {
    ...
    void testPointInsidePolygon() {
        ...
        assertTrue(polygon.inside(insidePoint)); // Oczekiwany wynik: prawda
    }
    ...
    void testPointOutsidePolygon() {
        ...
        assertFalse(polygon.inside(outsidePoint)); // Oczekiwany wynik: fałsz
    }
    ...
    void testPointOnEdgeOfPolygon() {
        ...
        assertFalse(polygon.inside(edgePoint)); // Oczekiwany wynik: fałsz
    }
}
